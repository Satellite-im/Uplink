...
impl crate::IconShape for Shape {
    ...
    fn path(&self) -> LazyNodes {
        match self {
            ...
            Shape::Keyboard => rsx! {
                path {
                    d: "m22.17,17.67H1.17V5.67s21,0,21,0v12ZM3.17,7.67h0m2,0h0m2.02,0h0m2.01,0h0m2.01,0h0m2.01,0h0m-8.99,2.02h0l-1-.02m3,.02h0m2.02,0h0m2.01,0h0m2.01,0h0m2.01,0h0m-8.98,2h0l-2.01-.02m4.01,0h0m2.02,0h0m2.01,0h0m2.01,0h0m4.02,0h0m-9.02,1.98h0m2.02,0h0m2.01,0h0m4.02,0h0m4,0h-2m-3-5.99h0m5.01,0h-1s0,0,0,0m-.99,2.02h0m-7.5,5.98h-3,7.5m4-4h1m-3.98-1.99h0m-.98,2h0m-1.01,1.98h0m3.01-5.99h0m0,8h0m3.01-5.99h0m0,5.99h-1s0,0,0,0m-13-2h-2s-1,0-1,0m2.51,2.01h0m-2,0h-.5s0,0,0,0",
                }
            },
            Shape::KeyboardSlash => rsx! {
                path {
                    d: "M7.5,11.51c0-.28,.22-.5,.5-.5h1c.28,0,.5,.22,.5,.5v1c0,.28-.22,.5-.5,.5h-1c-.28,0-.5-.22-.5-.5v-1Zm4.5,2.5c-.28,0-.5,.22-.5,.5v1c0,.28,.22,.5,.5,.5h1c.28,0,.5-.22,.5-.5v-1c0-.28-.22-.5-.5-.5h-1Zm4,2s.01,0,.02,0l-1.52-1.52s0,.01,0,.02v1c0,.28,.22,.5,.5,.5h1ZM2.5,6.51c0,.28,.22,.5,.5,.5h1c.28,0,.5-.22,.5-.5v-1c0-.28-.22-.5-.5-.5h-1c-.28,0-.5,.22-.5,.5v1Zm23,2c0-.28-.22-.5-.5-.5h-3c-.28,0-.5,.22-.5,.5v1c0,.28,.22,.5,.5,.5h3c.28,0,.5-.22,.5-.5v-1Zm-23,1c0,.28,.22,.5,.5,.5h2c.28,0,.5-.22,.5-.5v-1c0-.28-.22-.5-.5-.5H3c-.28,0-.5,.22-.5,.5v1Zm4.52-2.5l-1.52-1.52s0,.01,0,.02v1c0,.28,.22,.5,.5,.5h1s.01,0,.02,0Zm1.48,1.5s0-.02,0-.03l-.46-.46s-.02,0-.03,0h-1c-.28,0-.5,.22-.5,.5v1c0,.28,.22,.5,.5,.5h1c.28,0,.5-.22,.5-.5v-1ZM2.5,17.51v1c0,.28,.22,.5,.5,.5h3c.28,0,.5-.22,.5-.5v-1c0-.28-.22-.5-.5-.5H3c-.28,0-.5,.22-.5,.5Zm10-5v-.03s-1.47-1.47-1.47-1.47h-.03c-.28,0-.5,.22-.5,.5v1c0,.28,.22,.5,.5,.5h1c.28,0,.5-.22,.5-.5ZM2.5,15.51c0,.28,.22,.5,.5,.5H7c.28,0,.5-.22,.5-.5v-1c0-.28-.22-.5-.5-.5H3c-.28,0-.5,.22-.5,.5v1Zm5.5,3.5h11.03s-2-2-2-2H8c-.28,0-.5,.22-.5,.5v1c0,.28,.22,.5,.5,.5Zm2-5h-1c-.28,0-.5,.22-.5,.5v1c0,.28,.22,.5,.5,.5h1c.28,0,.5-.22,.5-.5v-1c0-.28-.22-.5-.5-.5Zm15.5-7.5v-1c0-.28-.22-.5-.5-.5h-1c-.28,0-.5,.22-.5,.5v1c0,.28,.22,.5,.5,.5h1c.28,0,.5-.22,.5-.5Zm-16,3c0,.28,.22,.5,.5,.5h.03s-.53-.53-.53-.53v.03Zm-7,3c0,.28,.22,.5,.5,.5h3c.28,0,.5-.22,.5-.5v-1c0-.28-.22-.5-.5-.5H3c-.28,0-.5,.22-.5,.5v1Zm23,2c0-.28-.22-.5-.5-.5h-4c-.28,0-.5,.22-.5,.5v1c0,.28,.22,.5,.5,.5h4c.28,0,.5-.22,.5-.5v-1Zm0-3c0-.28-.22-.5-.5-.5h-2c-.28,0-.5,.22-.5,.5v1c0,.28,.22,.5,.5,.5h2c.28,0,.5-.22,.5-.5v-1Zm-5-6v1c0,.28,.22,.5,.5,.5h1c.28,0,.5-.22,.5-.5v-1c0-.28-.22-.5-.5-.5h-1c-.28,0-.5,.22-.5,.5Zm5,12c0-.28-.22-.5-.5-.5h-3c-.21,0-.38,.13-.46,.3l1.7,1.7h1.76c.28,0,.5-.22,.5-.5v-1ZM10,5.01h-.76s1.26,1.26,1.26,1.26v-.76c0-.28-.22-.5-.5-.5ZM0,5.64v12.72c0,1.73,1.35,3.14,3,3.14H21.52s-1.5-1.5-1.5-1.5H3c-.83,0-1.5-.73-1.5-1.64V5.64c0-.9,.67-1.64,1.5-1.64h1.03s-1.45-1.45-1.45-1.45C1.12,2.77,0,4.07,0,5.64Zm24.23,14.36l1.42,1.42c1.34-.31,2.35-1.56,2.35-3.06V5.64c0-1.73-1.35-3.14-3-3.14H6.74s1.5,1.5,1.5,1.5H25c.83,0,1.5,.73,1.5,1.64v12.72c0,.9-.67,1.64-1.5,1.64h-.77Zm-4.23-12h-1c-.28,0-.5,.22-.5,.5v1c0,.28,.22,.5,.5,.5h1c.28,0,.5-.22,.5-.5v-1c0-.28-.22-.5-.5-.5Zm-2.5-2.5v1c0,.28,.22,.5,.5,.5h1c.28,0,.5-.22,.5-.5v-1c0-.28-.22-.5-.5-.5h-1c-.28,0-.5,.22-.5,.5Zm-.5,2.5h-1c-.28,0-.5,.22-.5,.5v1c0,.28,.22,.5,.5,.5h1c.28,0,.5-.22,.5-.5v-1c0-.28-.22-.5-.5-.5Zm-2.5-2.5v1c0,.28,.22,.5,.5,.5h1c.28,0,.5-.22,.5-.5v-1c0-.28-.22-.5-.5-.5h-1c-.28,0-.5,.22-.5,.5Zm-1.5,1.5c.28,0,.5-.22,.5-.5v-1c0-.28-.22-.5-.5-.5h-1c-.28,0-.5,.22-.5,.5v1c0,.28,.22,.5,.5,.5h1Zm5.24,7l1.26,1.26v-.76c0-.28-.22-.5-.5-.5h-.76Zm-4.24-6h-1c-.21,0-.38,.13-.46,.3l1.66,1.66c.18-.08,.3-.25,.3-.46v-1c0-.28-.22-.5-.5-.5Zm4,5c.28,0,.5-.22,.5-.5v-1c0-.28-.22-.5-.5-.5h-1c-.28,0-.5,.22-.5,.5v.76s.74,.74,.74,.74h.76Zm1.5-.5c0,.28,.22,.5,.5,.5h1c.28,0,.5-.22,.5-.5v-1c0-.28-.22-.5-.5-.5h-1c-.28,0-.5,.22-.5,.5v1Zm8.06,11.84h0c.29-.29,.29-.77,0-1.06L4.5,.22c-.29-.29-.77-.29-1.06,0h0c-.29,.29-.29,.77,0,1.06L26.5,24.34c.29,.29,.77,.29,1.06,0Z",
                }
            },
            Shape::Language => rsx! {
                path {
            ...
            Shape::Shuffle => rsx! {
                path {
                    d: "M 9 9.78 C 5.86 6.75 2.5 6.75 2.5 6.75 M 18.5 13.25 L 21.5 16.75 C 19.43 16.75 18.5 17.25 16 16.75 C 16 16.75 14.4 16.36 12.5 14.24 M 21.33 16.9 L 18.5 20.25 M 2.5 17.25 C 2.5 17.25 7.5 17.25 11 11.75 C 11.36 11.18 11.72 10.69 12.08 10.25 C 14.16 7.7 16 7.25 16 7.25 C 18.5 6.75 19.43 7.25 21.5 7.25 L 18.5 10.75 M 18.5 3.75 L 21.33 7.1",
                },
            },
