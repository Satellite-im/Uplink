...
settings-audio = SettingsAudio 
    ...
    .call-timer-description = Quando ativado, um cronómetro será exibido mostrando a duração da chamada.
settings-developer = SettingsDeveloper 
    ...
    .compress-download-cache-description = Para depurar com outros programadores, você pode compactar o cache e compartilhá-lo. Não faça isso se esta for sua conta real.
    .compress = Comprimir
