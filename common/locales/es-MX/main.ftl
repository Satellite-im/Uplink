...
files = Files
    ...
    .video-thumb = Thumbnail de video
    .image-thumb = Thumbnail de imagen
    .doc-thumb = Thumbnail de la primera página
    .no-thumbnail-preview = No hay thumbnail de vista previa para este archivo
...
settings-general = General Settings
    ...
    .splash-screen-description = Deshabilitar la pantalla de inicio puede acelerar los tiempos de carga.
...
settings-developer = Developer Settings 
    ...
    .open-debug-logger = Abrir el registrador
    .save-logs-to-file = Guardar registros en un archivo
