...
messages = Messages
    ...
    .not-friends = You are not connections anymore
...
friends = Connections
    .friends = Connections
    .cta-text = Things are better with connections.
    .add = Add Someone
    ...
    .requests = Requests
    .add-existing-friend = You are already connections!
...
files = Files
    ...
    .one-file-to-upload-name = File to Upload { $file }!
...
settings-notifications = Notifications
    ...
    .friends-description = Enable notifications for connection requests.
