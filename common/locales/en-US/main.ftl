...
settings-audio = Audio & Sound Settings 
    ...
    .input-device-test = Test Input Device
    .input-device-test-description = Test your input device.
    .output-device = Output Device
    .output-device-description = This is where all sounds will be played. (Usually your headphones).
    .output-device-test = Test Input Device
    .output-device-test-description = Test your input device.
