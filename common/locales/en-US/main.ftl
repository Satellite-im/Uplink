...
friends = Friends
    ...
    .not-creator = You're not creator
...
files = Files
    ...
    .upload = Upload
    .free-space = HD Free Space:
    .total-space = HD Total Space:
    .storage-max-size = Storage Max Size:
    .storage-current-size = Storage Current Size:
    .rename = Rename
    .download = Download
    .uploaded = Uploaded
