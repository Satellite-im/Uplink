...
updates = Actualizações
    ...
    .button-label = Escolher pasta de transferência
...
friends = Amigos
    ...
    .not-creator = Não és o criador do grupo
...
files = Ficheiros
    ...
    .one-file-to-upload-name = Ficheiro para carregar { $file }!
    ...
    .send-to-chat = Enviar para o chat
    .send-files-text-amount = Enviar { $amount } Ficheiro(s)
    .files-selected-paths = Ficheiro(s) selecionado(s): { $files_path }
